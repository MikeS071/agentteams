    ...
    <div className="flex min-h-screen items-center justify-center bg-bg px-4 py-12">
      <div className="w-full max-w-sm space-y-6 rounded-2xl border border-bg3 bg-bg2 p-8">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-text">Log in to AgentSquads</h1>
          <p className="mt-2 text-sm text-text2">Your AI team, ready to work</p>
        </div>
        ...
        <p className="text-center text-sm text-text2">
          ...
          <Link href="/signup" className="font-medium text-text underline underline-offset-2">
            Sign up
          </Link>
        </p>
      </div>
